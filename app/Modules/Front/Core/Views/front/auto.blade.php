...
<section class="product">
    ...
    <div class="product__list">
        <div class="wrapper">
            ...
            <!--</div>-->
            <div id="show-more-10" class="product__header show-more-all" style="padding: 15px 0 15px;">
                <div class="wrapper sample-title">
                    <h2>
                        <a  @click="showMore(10)" class="product-card__button our_green">
                            <i class="fas fa-sync" style="margin-right: 10px;"></i> больше автопарфюмов
                        </a>
                    </h2>
                </div>
            </div>
