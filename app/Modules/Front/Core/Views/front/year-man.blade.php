<!-- tap version Year set man parfumes 500 ml -->
        ...
        <div class="wrapper">
            <div class="product-list">
                ...
                <div v-cloak v-for="product in products"
                     v-if="((product.show && brandsSelected.length === 0) || (brandsSelected.length > 0 && brandsSelected.indexOf(product.bname) > -1 )) && product.man500 == 1"
            ...
            <div v-if="brandsSelected.length === 0">
                <div id="show-more-man500" class="product__header" style="padding: 15px 0 15px;">
                    <div class="wrapper sample-title">
                        <h2>
                            <a @click="showMore('man500')" class="product-card__button our_green show-more-all" >
                                <i class="fas fa-sync" style="margin-right: 10px;"></i> {{__('показать еще')}}
                            </a>
                        </h2>
                    </div>
                </div>
                <div id="more-background-man500" style="height: 140px; overflow: hidden; position: relative; ">
